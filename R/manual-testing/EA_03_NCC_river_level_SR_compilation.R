...
esc <- read.csv("escape_NCC_2023-Mar_20_clean.csv", header=TRUE, stringsAsFactors = FALSE)
...
for (k in 1:length(species)){ # for each species
    ...
    # ADD A NOTE ABOUT THE COLUMN NAMES IN ESCAPEMENT DATABASE 
...
write.csv(Z, "NCC_streams_river-level_SR_data_2023-Mar-20.csv", row.names = FALSE)

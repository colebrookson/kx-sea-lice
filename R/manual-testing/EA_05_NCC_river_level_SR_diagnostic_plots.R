    ...
    if (spp == "PKO"){
      ...
      legend("topright", c("Spawners","Recruits"),
        ...
        if (spp == "CM"){
              ...
              lines(d$BroodYear, d$Returns_Proportion_Age_3,type="l", lty=2, col=alpha(col1, 0.75))
              lines(d$BroodYear, d$Returns_Proportion_Age_4,type="l", lty=2, col=alpha(col2, 0.75))
              lines(d$BroodYear, d$Returns_Proportion_Age_5,type="l", lty=2, col=alpha(col3, 0.75))
              
              lines(d$BroodYear, d$Recruits_Age4/d$Recruits, type="l", lwd=2, col=alpha(col2, 0.75))
              lines(d$BroodYear, d$Recruits_Age5/d$Recruits, type="l", lwd=2, col=alpha(col3, 0.75))
      ...
      mtext(paste("Species:" , spp , "          System:", d$River[1],"          CU:", d$CU[1], sep=" "), side=3, outer=TRUE, cex=1.2, lwd=2, line=2)
